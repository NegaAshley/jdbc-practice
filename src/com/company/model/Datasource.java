...
public class Datasource {
    ...
    //Above is a prepared statement, which is treated as a literal value and never as a SQL value.  This protects
    //against SQL injections.

    public static final String INSERT_ARTISTS = "INSERT INTO " + TABLE_ARTISTS + '(' + COLUMN_ARTIST_NAME +
            ") VALUES(?)";
    ...
    public boolean open() {
        try {
            ...
            insertIntoArtists = conn.prepareStatement(INSERT_ARTISTS, Statement.RETURN_GENERATED_KEYS);//Second arg returns keys to be used in creation of row in Albums
    ...
    public void insertSong(String title, String artist, String album, int track) {
        try{
            ...
            try{
                ...
                System.out.println("Issue rolling back: " + e2.getMessage());
            }
        }finally{
            try{
